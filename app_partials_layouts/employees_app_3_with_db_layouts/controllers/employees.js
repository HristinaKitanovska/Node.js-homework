...
module.exports = {
  getAll: async (req, res) => {
    ...
    res.render('employees/index', { employees, title: 'Employees Homepage' });
  },
  getCreate: async (req, res) => {
    const companies = await Company.find();

    res.render('employees/create', { companies, title: 'Employee create' });
  },
  getEdit: async (req, res) => {
    const employee = await Employee.findById(req.params.id).populate('company');
    const companies = await Company.find();

    res.render('employees/edit', { employee, companies, title: 'Employee edit' });
  },
